...
class Barang extends Controller
{
    ...
    public function add()
    {
        ...
        echo '<script>
                alert("Sukses Tambah Data Kegiatan");
    ...
    public function edit($id)
    {
        ...
        if(isset($getBarang))
        {
            ...
            echo '<script>
                    alert("ID Kegiatan '.$id.' Tidak ditemukan");
                    window.location="'.base_url('barang').'"
                </script>';
        }
    }
    ...
    public function update()
    {
        ...
        echo '<script>
                alert("Sukses Edit Data Kegiatan");
                window.location="'.base_url('barang').'"
            </script>';
    ...
    public function hapus($id)
    {
        ...
        if(isset($getBarang))
        {
            ...
            echo '<script>
                    alert("Hapus Data Kegiatan Sukses");
                    window.location="'.base_url('barang').'"
                </script>';
            ...
            echo '<script>
                    alert("Hapus Gagal !, Kegiatan Kegiatan '.$id.' Tidak ditemukan");
                    window.location="'.base_url('barang').'"
                </script>';
        }
    }
